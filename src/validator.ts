...
const CHECKSUM_ALGORITHMS = new Set(["crc32", "crc32-reflected", "crc32-non-reflected"]);
const HASH_ALGORITHMS = new Set(["sha1", "sha256", "sha384", "sha512", "sha3-256", "sha3-384", "sha3-512"]);
